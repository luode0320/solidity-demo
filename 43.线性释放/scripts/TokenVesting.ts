...
// 需要部署的合约名称
const contractName: string = "TokenVesting";
// 合约的测试 html 名称
const contractHtml: string = "TokenVesting.html";
...
async function main() {
    ...
    const contract = await contractFactory.deploy("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266", 100);
    //  等待部署完成
