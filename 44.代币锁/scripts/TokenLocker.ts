...
// 需要部署的合约名称
const contractName: string = "TokenLocker";
// 合约的测试 html 名称
const contractHtml: string = "TokenLocker.html";
...
async function constructor(contractFactory: any) {
    ...
    const contract = await contractFactory.deploy("0xA51c1fc2f0D1a1b8494Ed1FE312d7C3a78Ed91C0", "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266", 100);
    return contract;
}
