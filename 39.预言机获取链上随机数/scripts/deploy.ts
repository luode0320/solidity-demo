...
// 预言机订阅id: https://vrf.chain.link/ 
const SUBSCRIPTION_ID: string = process.env.SUBSCRIPTION_ID!;
// VRF 协调员id: https://vrf.chain.link/ 
const VRF_ID: string = "0x9DdfaCa8183c41ad55329BdeeD9F6A8d53168B1B";
// 密钥哈希: https://vrf.chain.link/ 
const KEY_HASH: string = "0x787d74caea10b2b357790d5b5247c2f63d1d91572a9846f780606e4d953677ae";
...
async function main() {
    ...
    const contract = await contractFactory.deploy(SUBSCRIPTION_ID, VRF_ID, KEY_HASH);
    //  等待部署完成: 0xfc504Bd747ce1faEa801A7BA9aBeCD45a1505f27
