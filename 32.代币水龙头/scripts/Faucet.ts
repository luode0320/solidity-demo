...
// 需要部署的合约名称
const contractName: string = "Faucet";
// 合约的测试 html 名称
const contractHtml: string = "Faucet.html";
// 构造函数
const constructorAddress: string = process.env.DEPLOY_ADDRESS!;
...
async function main() {
    ...
    // 部署合约
    const contract = await contractFactory.deploy(constructorAddress);
    //  等待部署完成
