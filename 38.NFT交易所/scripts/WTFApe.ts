...
// 需要部署的合约名称
const contractName: string = "WTFApe";
// 合约的测试 html 名称
const contractHtml: string = "WTFApe.html";
// 构造函数
const constructorName: string = "luode";
const constructorSymbol: string = "ld";
...
async function main() {
    ...
    // 部署合约
    const contract = await contractFactory.deploy(constructorName, constructorSymbol);
    //  等待部署完成
